...
def parse_args():
    ...
    parser.add_argument('--weights', default=None, type=str,
                        help='path to weights file. For resnet101/152, ignore this arg to download from torchvision')
...
def main(args):
    ...
    if args.model == 'resnet101':
        ...
        model = RepLKNetForERF(large_kernel_sizes=[31, 29, 27, 13], layers=[2, 2, 18, 2],
